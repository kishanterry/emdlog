...
},{"./xhr":9}],7:[function(require,module,exports){
/**
 * JSONP client.
 */
...
},{"../promise":21,"../util":28,"./before":5,"./client/default":6,"./cors":10,"./header":11,"./interceptor":13,"./jsonp":14,"./method":15,"./mime":16,"./timeout":17}],13:[function(require,module,exports){
/**
 * Interceptor factory.
 */
    ...
    methods: {
        draft: function draft() {
            if (this.article.title.length && this.article.article.length) {
                ...
                this.$http.post('/articles/draft', this.article).then(function (response) {
        ...
        publish: function publish() {
            if (this.article.title.length && this.article.article.length) {
                ...
                this.$http.post('/articles/publish', this.article).then(function (response) {
                    this.article.id = response.data.id;
...
},{"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":2,"marked":3,"vue":29,"vue-resource":18}]},{},[30]);
